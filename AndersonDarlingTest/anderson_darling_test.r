...
plot.stepfun(f_1, main="Combined plots (plot for n = 10000 highlighted)", col=BLUE, lwd=2)
plot.stepfun(f_2, add=TRUE, col=BLUE, lwd=2)
plot.stepfun(f_3, add=TRUE, col=BLUE, lwd=2)
...
plot.stepfun(g_1, main="Combined limiting CDFs", col=BLUE, lwd=2)
plot.stepfun(g_2, add=TRUE, col=BLUE, lwd=2)
plot.stepfun(g_3, add=TRUE, col=BLUE, lwd=2)